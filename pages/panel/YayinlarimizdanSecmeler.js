...
export default function YayinlarimizdanSecmeler() {
    ...
    useEffect(() => {
        setIsLoading(true);
        setHasError(false);
        axios.get(`http://127.0.0.1:8000/api/appname/yayinlarimizdansecmeler/?page=${currentPage}`)
          .then(response => {
    ...
    const handlePageChange = (event, value) => {
      ...
      const handleSave = (editedItem) => {
        ...
        axios.put(`http://127.0.0.1:8000/api/appname/yayinlarimizdansecmeler/${editedItem.id}/`, formData)
          .then(response => {
      ...
      const handleAddNewItem = () => {
        ...
        axios.post('http://127.0.0.1:8000/api/appname/yayinlarimizdansecmeler/', formData)
          .then(response => {
            // Mevcut sayfayı yeniden yüklüyoru
            return axios.get(`http://127.0.0.1:8000/api/appname/yayinlarimizdansecmeler/?page=${currentPage}`);
          })
          .then(response => {
            setData(response.data.results);
            setTotalPages(Math.ceil(response.data.count / 10));
    ...
    const handleDeleteSelected = () => {
        ...
        axios.post('http://127.0.0.1:8000/api/appname/yayinlarimizdansecmeler/bulk_soft_delete/', { ids: selectedIds })
          .then(() => axios.get(`http://127.0.0.1:8000/api/appname/yayinlarimizdansecmeler/`))
          .then(response => {
            ...
            if (updatedPage !== currentPage) {
              return axios.get(`http://127.0.0.1:8000/api/appname/yayinlarimizdansecmeler/?page=${updatedPage}`);
            } else {
              return response;
            }
          })
