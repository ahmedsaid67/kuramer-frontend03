...
const MenuListItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 64, text: 'E bülten Aboneleri', url: '/panel/yayinlar/aboneler' },
      { id: 65, text: 'E bülten', url: '/panel/yayinlar/ebulten' },
    ...
    <Box sx={{ width: drawerWidth }}>
      <Typography 
        ...
        style={{
          ...
          color: '#507dac', // Dikkat çekici bir renk
          fontSize: "18px" // Font boyutunu artır
        }}
      >
      ...
      <List>
        {selectedSubItems.map((subItem) => (
          <React.Fragment key={subItem.id}>
            <ListItem 
              selected={activeSubTab === subItem.id}
              ...
              <ListItemText 
                primary={
                  <Typography 
                    ...
                    style={{ 
                      fontWeight: 'bold', 
                      color: activeSubTab === subItem.id ? 'black' : 'grey',
                      fontSize:"16px"
                    }}
                  >
                    {subItem.text}
            ...
            <List component="div" disablePadding className={styles.nestedList}>
              {subItem.children?.map((subSubItem) => (
                <ListItem 
                  key={subSubItem.id}
                  selected={activeSubSubTab === subSubItem.id}
                  ...
                  <ListItemText 
                    primary={
                      <Typography 
                        ...
                        style={{ 
                          fontWeight: 'bold', 
                          color: activeSubSubTab === subSubItem.id ? 'black' : 'grey',
                          fontSize:"16px"
                        }}
                      >
                        {subSubItem.text}
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer
        ...
        sx={{
          width: drawerWidth,
          flexShrink: 0,
          [`& .MuiDrawer-paper`]: { width: drawerWidth, boxSizing: 'border-box', backgroundColor:"#3a3b3c;" },
        }}
      >
        <Toolbar />
        <Box sx={{ overflow: 'auto' }}>
          <List>
            {MenuListItems.map((item) => (
              <ListItem 
                key={item.id}
                selected={activeMainTab === item.id}
